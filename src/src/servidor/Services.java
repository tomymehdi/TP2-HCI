...
import errors.catalogError;
import errors.securityError;
				 ...
				 try {
				        ...
				        for (int i = 0; i < nodes.getLength(); i++) {
				           ...
				           ans.add(new Category(id,code,name));
					        ...
					        int code=Integer.parseInt(element.getAttribute("code"));
			...
			private User parseUser(String response) {
				...
				Document doc=null;
				 ...
				 try {
			    	...
			    	RequestError err=new securityError(code, langid);
			    	err.handle(e);
