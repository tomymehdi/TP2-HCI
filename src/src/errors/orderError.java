...
public class orderError  implements RequestError{
	...
	public void handle(Exception e) {
		...
		case 13: System.out.println("La solicitud requiere de un identificador de orden el cual no fue provisto.");
		case 14: System.out.println("La solicitud requiere de un identificador de dirección el cual no fue provisto.");
		...
		case 115: System.out.println("El identificador de orden suministrado es inválido.");
		case 116: System.out.println("La operación solicitada es inválida para el estado de la orden.");
		case 117: System.out.println("El identificador de la dirección suministrado es inválido.");
		case 999: System.out.println("Se produjo un error inesperado procesando la solicitud.");
		default: System.out.println("Se produjo un error en el acceso a la orden.");
			...
			case 13:System.out.println("Missing order id");
			case 14: System.out.println("Missing address id.");
			...
			case 115: System.out.println("Invalid order id.");
			case 116: System.out.println("Invalid operation.");
			case 117: System.out.println("Invalid address id.");
			case 999: System.out.println("Unknown error");
			default: System.out.println("Error accesing to order.");
			}
		}
	}
